...
public class Utility {
	...
	String value =
	WorkbookFactory.create(myFile).getSheet("Sheet1").getRow(row).getCell(cell).getStringCellValue();
	...
	File dest= new File("D:\\Java\\Selenium\\Screenshots\\S"+screenShotName+".png");
